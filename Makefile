#############################################################################
# Makefile for building: chatclient.out
# Generated by qmake (3.1) (Qt 5.9.5)
# Project:  chatClient.pro
# Template: app
# Command: /home/ben/anaconda3/bin/qmake -o Makefile chatClient.pro
#############################################################################
...
Makefile: chatClient.pro ../../../anaconda3/mkspecs/linux-g++/qmake.conf ../../../anaconda3/mkspecs/features/spec_pre.prf \
		../../../anaconda3/mkspecs/common/unix.conf \
		../../../anaconda3/mkspecs/common/linux.conf \
		../../../anaconda3/mkspecs/common/sanitize.conf \
		../../../anaconda3/mkspecs/common/gcc-base.conf \
...
install_target: first FORCE
	@test -d $(INSTALL_ROOT)/opt/chatclient.out/bin || mkdir -p $(INSTALL_ROOT)/opt/chatclient.out/bin
	-$(QINSTALL_PROGRAM) $(QMAKE_TARGET) $(INSTALL_ROOT)/opt/chatclient.out/bin/$(QMAKE_TARGET)
	-$(STRIP) $(INSTALL_ROOT)/opt/chatclient.out/bin/$(QMAKE_TARGET)

uninstall_target: FORCE
	-$(DEL_FILE) $(INSTALL_ROOT)/opt/chatclient.out/bin/$(QMAKE_TARGET)
	-$(DEL_DIR) $(INSTALL_ROOT)/opt/chatclient.out/bin/ 
