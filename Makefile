#############################################################################
# Makefile for building: Project2-client
# Generated by qmake (3.1) (Qt 5.9.5)
# Project:  Project2-client.pro
# Template: app
# Command: /home/ben/anaconda3/bin/qmake -o Makefile Project2-client.pro
#############################################################################
...
INSTALL_DIR   = cp -f -R
QINSTALL      = /home/ben/anaconda3/bin/qmake -install qinstall
QINSTALL_PROGRAM = /home/ben/anaconda3/bin/qmake -install qinstall -exe
DEL_FILE      = rm -f
SYMLINK       = ln -f -s
DEL_DIR       = rmdir
MOVE          = mv -f
...
SOURCES       = main.cpp \
		...
		Parsing.cpp \
		tcpClientSocket.cpp \
		tcpUserSocket.cpp moc_mainwindow.cpp
OBJECTS       = main.o \
		mainwindow.o \
		chatClient.o \
		client.o \
...
DIST          = chatClient.out \
		...
		Project2-client.pro mainwindow.h \
		client.h \
		Parsing.h \
		tcpClientSocket.h \
		tcpUserSocket.h main.cpp \
		mainwindow.cpp \
		chatClient.cpp \
		client.cpp \
		Parsing.cpp \
...
Makefile: Project2-client.pro ../../../anaconda3/mkspecs/linux-g++/qmake.conf ../../../anaconda3/mkspecs/features/spec_pre.prf \
		../../../anaconda3/mkspecs/common/unix.conf \
		../../../anaconda3/mkspecs/common/linux.conf \
		../../../anaconda3/mkspecs/common/sanitize.conf \
		../../../anaconda3/mkspecs/common/gcc-base.conf \
	...
	$(QMAKE) -o Makefile Project2-client.pro
../../../anaconda3/mkspecs/features/spec_pre.prf:
../../../anaconda3/mkspecs/common/unix.conf:
../../../anaconda3/mkspecs/common/linux.conf:
../../../anaconda3/mkspecs/common/sanitize.conf:
...
distdir: FORCE
	...
	$(COPY_FILE) --parents mainwindow.h client.h Parsing.h tcpClientSocket.h tcpUserSocket.h $(DISTDIR)/
	$(COPY_FILE) --parents main.cpp mainwindow.cpp chatClient.cpp client.cpp Parsing.cpp tcpClientSocket.cpp tcpUserSocket.cpp $(DISTDIR)/
...
ui_mainwindow.h: mainwindow.ui \
		../../../anaconda3/bin/uic
	/home/ben/anaconda3/bin/uic mainwindow.ui -o ui_mainwindow.h
...
tcpUserSocket.o: tcpUserSocket.cpp tcpUserSocket.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o tcpUserSocket.o tcpUserSocket.cpp
...
install_target: first FORCE
	@test -d $(INSTALL_ROOT)/opt/Project2-client/bin || mkdir -p $(INSTALL_ROOT)/opt/Project2-client/bin
	-$(QINSTALL_PROGRAM) $(QMAKE_TARGET) $(INSTALL_ROOT)/opt/Project2-client/bin/$(QMAKE_TARGET)
	-$(STRIP) $(INSTALL_ROOT)/opt/Project2-client/bin/$(QMAKE_TARGET)

uninstall_target: FORCE
	-$(DEL_FILE) $(INSTALL_ROOT)/opt/Project2-client/bin/$(QMAKE_TARGET)
	-$(DEL_DIR) $(INSTALL_ROOT)/opt/Project2-client/bin/ 
