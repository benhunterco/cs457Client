...
QT_MOC_LITERAL(9, 90, 21), // "requestUsernameUpdate"
QT_MOC_LITERAL(10, 112, 8), // "username"
QT_MOC_LITERAL(11, 121, 21), // "requestTabCloseByName"
QT_MOC_LITERAL(12, 143, 7) // "tabName"

    },
    "displayWorker\0requestDisplay\0\0message\0"
    "tab\0focus\0requestFailure\0requestStatusUpdate\0"
    "status\0requestUsernameUpdate\0username\0"
    "requestTabCloseByName\0tabName"
};
...
void displayWorker::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 3: _t->requestUsernameUpdate((*reinterpret_cast< QString(*)>(_a[1]))); break;
        case 4: _t->requestTabCloseByName((*reinterpret_cast< QString(*)>(_a[1]))); break;
        default: ;
        }
        ...
        {
            typedef void (displayWorker::*_t)(QString );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&displayWorker::requestUsernameUpdate)) {
                *result = 3;
                return;
            }
        }
        {
            typedef void (displayWorker::*_t)(QString );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&displayWorker::requestTabCloseByName)) {
                *result = 4;
                return;
            }
        }
...
// SIGNAL 3
void displayWorker::requestUsernameUpdate(QString _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(&_t1)) };
...
// SIGNAL 4
void displayWorker::requestTabCloseByName(QString _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(&_t1)) };
